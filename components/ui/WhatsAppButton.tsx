...
export function WhatsAppButton({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Tooltip */}
      {showTooltip && (
        <div className="relative bg-white text-gray-800 text-sm font-semibold px-4 py-3 rounded-2xl shadow-2xl border border-gray-100 max-w-[220px] text-right">
          <p className="text-[#1E4D8C] font-bold mb-1">¡Hola! 👋</p>
          <p className="text-gray-600 text-xs leading-relaxed">
            Soy la gerente de ventas. ¿En qué plataforma te puedo ayudar?
          </p>
      ...
      <div className="relative">
        ...
        <a
          ...
          style={{
            boxShadow:
              "0 8px 32px rgba(37, 211, 102, 0.5), 0 4px 16px rgba(0,0,0,0.2)",
          }}
      ...
      <div className="bg-[#1E4D8C] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg whitespace-nowrap">
        💬 Escríbenos ahora
      </div>
    </div>
  );
